...
public class WavFile
{
	...
	// Cannot instantiate src.WavFile directly, must either use newWavFile() or openWavFile()
	private WavFile()
	{
	...
	{
		if (ioState != IOState.READING) throw new IOException("Cannot read from src.WavFile instance");
	...
	{
		if (ioState != IOState.WRITING) throw new IOException("Cannot write to src.WavFile instance");
